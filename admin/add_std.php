...
{	 
	 ...
	 $sql= "INSERT INTO student_list (first_name,last_name,email,enrollment,department,photo)
	 VALUES ('$first_name','$last_name','$email','$enrollment','$department','$photo')";
...
?>
        ...
        <div class="flex items-center justify-center p-7 mx-10 rounded-lg shadow-lg bg-white max-w-md">
            <form action="" method="post">
                ...
                <div class="form-group mb-6">
                    <input type="number" name="enrollment" id="" class="block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" placeholder="Enrollment" required>
                </div>
                <div class="form-group mb-6">
